...
Page({
            ...
            success(res2) {
              ...
              if (res2.statusCode === 200) {
                wx.getFileSystemManager().readFile({ //读取本地文件
                  ...
                  success: res3 => {
                    //接收到的数据通过buf2hex 转换成16进制
                    let fileStr = self.buf2hex(res3.data);
                    ...
                    wx.onBLECharacteristicValueChange((res) => {
                      ...
                      switch (guest.substr(14, 2)) {
                        ...
                        case "12":
                          //升级完成
                          console.log("guest.substr(16, 2):"+guest.substr(16, 2))
  ...
  send(scs) { //发送数据并读取返回数据 data为需要发送的数据指令（16位16进制组成的字符串）
    ...
    //clearInterval(self.data.countdown); //结束倒计时
    //console.log(app.globalData.bluetooth.deviceId, buffer, this.data.order);
